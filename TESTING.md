...
- 2026-07-22：Xcode 可识别 `Eason’s iPhone`，但设备状态为 Offline，项目也尚未选择 Personal Team，因此未声称完成真机安装或 iPhone Mirroring 检查。
- Xcode 27 beta 偶尔在测试结束后的诊断收集阶段报告 `simctl` 路径提示；这不是应用或测试失败，`xcresulttool` 的最终结果为 Passed。

## 手工视觉矩阵

已截图核对：Light、Dark、iPhone 17 Pro、iPhone 17e、英文、简体中文、Dashboard、Quarters、Planner、Settings、demo data。Dynamic Type、Reduce Motion、Reduce Transparency、全 P/NP、长课程名、GPA 0/4.0、导入错误和 Face ID unavailable 由 Preview、逻辑分支或自动测试覆盖；真机 Face ID 仍需设备所有者授权后检查。
