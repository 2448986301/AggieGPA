        ...
        NavigationStack {
            Form {
                ...
                Section("On-Device Intelligence") {
                    NavigationLink("On-Device Intelligence") { OnDeviceIntelligenceSettingsView() }
                        .accessibilityIdentifier("onDeviceIntelligenceLink")
                    Text("Download, switch, or remove local models. Models stay on this device and are never required for the core gradebook.")
                        .font(.footnote).foregroundStyle(.secondary)
                }
